...
export const cricketGrounds: CricketGround[] = [
  {
    ...
    availability: {
      ...
      bookedSlots: ["08:00-09:00", "18:00-19:00"],
    },
    features: {
  ...
  },
  {
    ...
    availability: {
      ...
      bookedSlots: ["10:00-11:00", "16:00-17:00"],
    },
    features: {
      pitchType: "Matting",
      capacity: 16,
  ...
  },
  {
    ...
    availability: {
      ...
      bookedSlots: ["12:00-13:00", "18:00-19:00", "20:00-21:00"],
    },
    features: {
      pitchType: "Synthetic",
      capacity: 24,
  ...
  },
  {
    ...
    availability: {
      ...
      bookedSlots: ["06:00-07:00", "14:00-15:00"],
    },
    features: {
      pitchType: "Concrete",
      capacity: 18,
  ...
  },
  {
    ...
    availability: {
      ...
      bookedSlots: ["10:00-11:00", "20:00-21:00"],
    },
    features: {
      pitchType: "Artificial Turf",
      capacity: 22,
  ...
  },
  {
    ...
    availability: {
      ...
      bookedSlots: ["08:00-09:00", "16:00-17:00", "18:00-19:00"],
    },
    features: {
      pitchType: "Matting",
      capacity: 16,
